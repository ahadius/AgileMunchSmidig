...
function StartingPage() {
  ...
  return (
    <div className="Main">
      <div className={clicked ? "container clicked" : "container"}>
        ...
        {clicked && (
          <>
            ...
            <button className="new-button2" onClick={() => handleClick("normal gamemode, lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ")}>
              Normal Mode 
            </button>
            <button className="new-button3" onClick={() => handleClick("competitive gamemode, lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod")}>
              Competitive Mode
            </button>
      ...
      {gameMode && <h2 className="selectedGameMode">In the {gameMode}</h2>}
    </div>
  );
}
